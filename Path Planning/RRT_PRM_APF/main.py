# 2D Static RRT/PRM/APF comparison with a static goal
# Static obstacles
...
def main():
    ...
    planners = {
        ...
        "PotentialFields": PotentialFields(env, start, goal, step_size=0.05, max_steps=500)
    }
    ...
    for name, planner in planners.items():
        ...
        if path is not None:
            ...
            ax.plot(path_x, path_y, 'g-', linewidth=2, label=f'{name} Path')
